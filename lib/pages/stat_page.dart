            ...
            child: Stack(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text('Covid-19 stats overview',
                      style: TextStyle(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Container(
                            padding:
                                EdgeInsets.only(top: 10, left: 5, bottom: 0),
                            child: Text(
                              "${ind_tot}",
                              style: TextStyle(
                                color: Colors.red[700],
                          ...
                          Container(
                            padding: EdgeInsets.only(top: 10, bottom: 0, right:5),
                            child: Text(
                              '${ind_rec}',
                              style: TextStyle(
                                color: Colors.green[700],
                          ...
                          Container(
                            padding:
                                EdgeInsets.only(top: 10, right: 5, bottom: 0),
                            child: Text(
                              '${ind_ded}',
                              style: TextStyle(
                                color: Colors.blueGrey[700],
